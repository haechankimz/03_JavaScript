...
resList.push(new Restaurant("왕가탕후루", "샤인머스켓, 딸기, 통귤", "서울시 중구 어딘가"));

// 화면에 존재하는 요소들 얻어오기(button, input)
const resName = document.querySelector("#resName");
const resAdress = document.querySelector("#resAddress");
...
selectBtn.addEventListener("click", () => {
  ...
  /* 만들어진 li에 내용으로 resList[i]의 information 메서드 반환 값 대입 */

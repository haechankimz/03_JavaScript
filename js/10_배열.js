...
function check3(){
    ...
    const arr = [10, 20, 50, 100, 1000];

    // index는 0부터 배열 길이 -1까지 1씩증가
...
function orderFn(){
    ...
    // 가격 배열
    const prices = [4000, 3000, 5000, 4500]; 

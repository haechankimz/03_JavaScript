...
const recodetBtn = document.querySelector("#recodetBtn");
const resetBtn = document.querySelector("#resetBtn");
const recodeContainer = document.querySelector("#recodeContainer");

...
function Student(name, grade, ban, number, score){
  ...
  this.introduce = function(){
    console.log(`${this.grade}학년 ${this.ban}반 ${this.number}번 ${this.name} ${this.score}점 입니다`);
  }
...
btn3.addEventListener("click", () => {
  ...
  const student1 = new Student("홍길동", 3, 5, 14, 80);
  console.log(student1);
  
  const student2 = new Student("김해찬", 2, 1, 8, 85);
  ...
  // 바로 studentList에 추가
  studentList.push(new Student("김미영", 2, 8, 7, 90));
  studentList.push(new Student("김짱구", 1, 2, 27, 80));
